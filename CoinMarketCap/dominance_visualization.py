...
# 선택자를 이용하여
# 선택자가 시간이 지날수록 변경될 수 있으므로 
# dominance_element = soup.select_one('선택자 기입') 으로 하면됨

dominance_element = soup.select_one('#__next > div.sc-25a97560-1.cdPNnt > div.main-content > div.sc-25a97560-0.jqezmE > div > div:nth-child(2) > div > div > div > div.cmc-global-stats__content > div > div:nth-child(5) > a')
